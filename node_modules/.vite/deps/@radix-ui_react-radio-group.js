...
var Radio = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime7.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
...
var RadioIndicator = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime7.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime7.jsx)(
      Primitive.span,
      {
...
var RadioGroupIndicator = React23.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime8.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
