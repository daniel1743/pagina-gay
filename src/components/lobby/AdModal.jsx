...
const AdModal = ({ ad, isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-background border-border max-w-2xl rounded-2xl p-0 overflow-hidden">
        {/* Hero Image */}
        <div className="relative h-64 overflow-hidden">
          ...
          <Button
            ...
            size="icon"
            onClick={onClose}
            className="absolute top-4 right-4 bg-black/50 backdrop-blur-sm hover:bg-black/70 text-white rounded-full"
          >
            <X className="w-5 h-5" />
          </Button>
