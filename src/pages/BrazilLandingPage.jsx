...
const BrazilLandingPage = () => {
  ...
  // ✅ SEO: Canonical tag específico para Brasil
  useCanonical('/br');
  ...
  React.useEffect(() => {
    ...
    document.title = 'Chat Gay Brasil | Grátis e Anônimo';
    ...
    ensuredMeta.content = 'Chat gay Brasil sem cadastro. Conhecer homens reais, chat gay ativo, conversar grátis sem conta. Gente real conversando agora.';
            ...
            <div className="text-center max-w-3xl w-full">
              ...
              >
                <span className="bg-gradient-to-r from-purple-400 via-purple-500 to-cyan-400 bg-clip-text text-transparent">
                  Chat com Gays do Brasil: Sem complicação, sem cadastro e 100% Real.
                </span>
              </motion.h1>
