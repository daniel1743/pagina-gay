...
const MexicoLandingPage = () => {
  ...
  React.useEffect(() => {
    ...
    document.title = 'Chat Gay México | Gratis y Anónimo';
    ...
    ensuredMeta.content = 'Chat gay México sin registro. Conocer hombres reales, chat gay activo, chatear gratis sin cuenta. Gente real conversando ahora.';
            ...
            <div className="text-center max-w-3xl w-full">
              ...
              >
                <span className="bg-gradient-to-r from-purple-400 via-purple-500 to-cyan-400 bg-clip-text text-transparent">
                  Chatea con Gays de México: Sin vueltas, sin registros y 100% Real.
                </span>
              </motion.h1>
