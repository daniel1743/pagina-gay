-- Chactivo / Supabase-first: consolidado local de migraciones 0001–0032.
-- PRECAUCIÓN: este archivo NO fue ejecutado por Manus ni validado contra PostgreSQL/Supabase remoto.
-- Ejecutarlo solo manualmente, en orden, después de respaldo/export y revisión en un proyecto de prueba.
-- No usar este archivo como sustituto de migraciones versionadas en producción.
-- No contiene secretos ni service-role keys.

-- ============================================================================
-- 202608270001_identity_profiles.sql (migración 01)
-- ============================================================================
...
-- ============================================================================
-- 202608270002_chat_private_moderation.sql (migración 02)
-- ============================================================================
...
-- ============================================================================
-- 202608270003_opin_baul_media.sql (migración 03)
-- ============================================================================
...
-- ============================================================================
-- 202608270004_rls_storage_realtime.sql (migración 04)
-- ============================================================================
...
-- ============================================================================
-- 202608270005_baul_rpc.sql (migración 05)
-- ============================================================================
...
-- ============================================================================
-- 202608270006_private_chat_rpc.sql (migración 06)
-- ============================================================================
...
-- ============================================================================
-- 202608270007_opin_metrics.sql (migración 07)
-- ============================================================================
...
-- ============================================================================
-- 202608270008_private_contacts.sql (migración 08)
-- ============================================================================
...
-- ============================================================================
-- 202608270009_moderation_rpc.sql (migración 09)
-- ============================================================================
...
-- ============================================================================
-- 202608270010_public_chat_moderation.sql (migración 10)
-- ============================================================================
...
-- ============================================================================
-- 202608270011_system_notifications.sql (migración 11)
-- ============================================================================
...
-- ============================================================================
-- 202608270012_chat_states.sql (migración 12)
-- ============================================================================
...
-- ============================================================================
-- 202608270013_reports_moderation.sql (migración 13)
-- ============================================================================
...
-- ============================================================================
-- 202608270014_events.sql (migración 14)
-- ============================================================================
...
-- ============================================================================
-- 202608270015_verification.sql (migración 15)
-- ============================================================================
...
-- ============================================================================
-- 202608270016_rewards.sql (migración 16)
-- ============================================================================
...
-- ============================================================================
-- 202608270017_activity_ranking.sql (migración 17)
-- ============================================================================
...
-- ============================================================================
-- 202608270018_tickets.sql (migración 18)
-- ============================================================================
...
-- ============================================================================
-- 202608270019_analytics.sql (migración 19)
-- ============================================================================
...
-- ============================================================================
-- 202608270020_daily_limits.sql (migración 20)
-- ============================================================================
...
-- ============================================================================
-- 202608270021_esencias.sql (migración 21)
-- ============================================================================
...
-- ============================================================================
-- 202608270022_forum.sql (migración 22)
-- ============================================================================
...
-- ============================================================================
-- 202608270023_contact_safety.sql (migración 23)
-- ============================================================================
...
-- ============================================================================
-- 202608270024_badges.sql (migración 24)
-- ============================================================================
...
-- ============================================================================
-- 202608270025_featured_ads.sql (migración 25)
-- ============================================================================
...
-- ============================================================================
-- 202608270026_baul_media_paths.sql (migración 26)
-- ============================================================================
...
-- ============================================================================
-- 202608270027_chat_replies_profile_guards.sql (migración 27)
-- ============================================================================
...
-- ============================================================================
-- 202608270028_private_replies_rpc.sql (migración 28)
-- ============================================================================
...
-- ============================================================================
-- 202608270029_security_definer_grants.sql (migración 29)
-- ============================================================================
...
-- ============================================================================
-- 202608270030_baul_set_like.sql (migración 30)
-- ============================================================================
...
-- ============================================================================
-- 202608270031_baul_match_reads.sql (migración 31)
-- ============================================================================
...
-- ============================================================================
-- 202608270032_baul_media_read_policies.sql (migración 32)
-- ============================================================================
...
-- ============================================================================
-- 202608270033_ticket_log_hardening.sql (migración 33)
-- ============================================================================
...
-- ============================================================================
-- 202608270034_private_request_notification_state.sql (migración 34)
-- ============================================================================
...
-- ============================================================================
-- 202608270035_explicit_table_grants.sql (migración 35)
-- ============================================================================
