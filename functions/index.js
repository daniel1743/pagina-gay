/**
 * Cloud Functions para Chactivo
 *
 * En esta etapa se mantienen solo funciones de seguridad, retención,
 * limpieza de media y notificaciones estrictamente justificadas.
 */
...
// notifyOnMatch, notifyOnPrivateChatRequest y notifyOnOpinReply retiradas.
// El producto conserva inbox/notificaciones internas; se sacrifica push social no crítica.
...
exports.dispatchUserNotification = onCall(
  ...
  async (request) => {
    ...
    if (!allowedActions.has(action)) {
      throw new HttpsError("failed-precondition", "Action deshabilitada por control de costo.");
    }
